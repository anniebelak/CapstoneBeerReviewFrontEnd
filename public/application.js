...
var config = {
  apiOrigins: {
    production: 'https://peaceful-badlands-52624.herokuapp.com',
...
var scriptsEvents = __webpack_require__(13);
$(function () {
...
var getLocations = function getLocations(event) {
  event.preventDefault();
  api.index().then(function (locations) {
    $(document).on('click', '.select-beer', onSelectBeer);
    return locations;
  }).then(ui.getLocationsSuccess).catch(ui.getLocationssFailure);
};

var getReviews = function getReviews(event) {
  event.preventDefault();
  api.ReviewIndex().then(function (reviews) {
    $(document).on('click', '.select-review', onSelectReview);
    return reviews;
  }).then(ui.getReviewsSuccess).catch(ui.getReviewsFailure);
};
...
var onCreateReview = function onCreateReview(event) {
  ...
  api.createReview(reviewData).then(ui.createReviewSuccess).catch(ui.createReviewFailure);
};

var onSelectBeer = function onSelectBeer(event) {
  event.preventDefault();
  var selectedBeerId = $(this).parent().attr('data-id');
  api.show(selectedBeerId).then(ui.getBeerSuccess).catch(ui.getBeerFailure);
};
var onSelectReview = function onSelectReview(event) {
  event.preventDefault();
  var selectedReviewId = $(event.target).attr('data-id');
  api.showReview(selectedReviewId).then(ui.getReviewSuccess).catch(ui.getReviewFailure);
};

var onDeleteReview = function onDeleteReview(event) {
  event.preventDefault();
  var deleteID = $(event.target).attr('data-id');
  api.deleteReview(deleteID).then(ui.deleteReviewSuccess).then(onDeleteReviewRefresh).catch(ui.removeReFailure);
};

var onDeleteReviewRefresh = function onDeleteReviewRefresh(event) {
  api.ReviewIndex().then(ui.removeReviewRefreshSuccess).catch(ui.removeReFailure);
};

var onUpdateReview = function onUpdateReview(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var reviewId = data.review.review_id;
  event.preventDefault();
  api.updateReview(reviewId, data).then(ui.updateReviewSuccess).catch(ui.updateReviewSuccessFailure);
};
...
var ReviewIndex = function ReviewIndex(data) {
  return $.ajax({
...
var showReview = function showReview(data) {
  return $.ajax({
...
var updateReview = function updateReview(reviewId, data) {
  return $.ajax({
...
var store = __webpack_require__(6);
var showLocationsTemplate = __webpack_require__(17);
var showReviewsTemplate = __webpack_require__(34);
var selectBeerTemplate = __webpack_require__(35);
var selectReviewTemplate = __webpack_require__(36);
...
var getLocationsFailure = function getLocationsFailure() {
...
var getBeerSuccess = function getBeerSuccess(data) {
  $('#message').text('You have successfully selected a yummy beverage!');
  $('.location').html('');
  var selectBeerHTML = selectBeerTemplate({ beer: data.beer });
  $('.selectbeer').html(selectBeerHTML);
  $('.chosen-review').html('');
};
var getBeerFailure = function getBeerFailure() {
...
var getReviewSuccess = function getReviewSuccess(data) {
  ...
  $('.reviews').html('');
  var selectReviewHTML = selectReviewTemplate({ review: data.review });
  $('.chosen-review').html(selectReviewHTML);
  $('.selectbeer').html('');
};
var getReviewFailure = function getReviewFailure() {
...
var removeReviewRefreshSuccess = function removeReviewRefreshSuccess(data) {
  var showReviewsHTML = showReviewsTemplate({ reviews: data.reviews });
  $('.reviews').html(showReviewsHTML);
};
...
module.exports = {
  ...
  getBeerSuccess: getBeerSuccess,
  getBeerFailure: getBeerFailure,
  deleteReviewFailure: deleteReviewFailure,
  deleteReviewSuccess: deleteReviewSuccess,
  getReviewFailure: getReviewFailure,
  ...
  removeReviewRefreshSuccess: removeReviewRefreshSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"location\" data-id=\""
    + alias1(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <h2>Brewery: "
    + alias1(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"name","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h2>\n  <h2>Brewery Address:"
    + alias1(((helper = (helper = helpers.address || (depth0 != null ? depth0.address : depth0)) != null ? helper : alias3),(typeof helper === alias4 ? helper.call(alias2,{"name":"address","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h2>\n\n"
    + ((stack1 = helpers.each.call(alias2,((stack1 = blockParams[0][0]) != null ? stack1.beers : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "    <div class=\"beer\" data-id=\""
    ...
    + "</h4>\n    <h4>Type:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.beer_type : stack1), depth0))
    + "</h4>\n     <h4>Description:"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "</h4>\n     <button class='select-beer' type='click'>Select Beer to Review</button>\n</div>\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"reviewslist\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <h2>Review</h2>\n  <h2>Comments</h2>\n  <h4>"
    + alias2(((helper = (helper = helpers.comment || (depth0 != null ? depth0.comment : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"comment","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h4>\n  <h2>How hoppy was it?</h2>\n  <h4>"
    + alias2(((helper = (helper = helpers.rating || (depth0 != null ? depth0.rating : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"rating","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</h4>\n  <div>\n    <div class=\"beer\" data-id=\""
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1)) != null ? stack1.id : stack1), depth0))
    + "\">\n    <h4>Beer:"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n    <h4>Type:"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1)) != null ? stack1.beer_type : stack1), depth0))
    + "</h4>\n     <h4>Description:"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.beer : stack1)) != null ? stack1.description : stack1), depth0))
    + "</h4>\n     <button class=\"delete-reviews\" type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">DELETE</button>\n   </div>\n   <br>\n     <button class=\"select-review\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Select to Edit your Review.</button>\n</div>\n</div>\n</div>\n";
},"4":function(container,depth0,helpers,partials,data) {
    return "<h4>No Reviews, please go to Local Breweries to select a tasty beverage to review!</h4>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.reviews : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"beer\" data-id=\""
    ...
    + "</h4>\n    <h4>Type:"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.beer : depth0)) != null ? stack1.beer_type : stack1), depth0))
    + "</h4>\n     <h4>Description:"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.beer : depth0)) != null ? stack1.description : stack1), depth0))
    + "</h4>\n<div id=\"center-form\">\n  <form id=\"creatingReview\">\n    <fieldset>\n      <input type='hidden' name='review[beer_id]' value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.beer : depth0)) != null ? stack1.id : stack1), depth0))
    + "\"\n        <h4>Comment</h4>\n     <input type='text' class='reviewcomment' name='review[comment]' value=\""
    + alias2(((helper = (helper = helpers.comment || (depth0 != null ? depth0.comment : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"comment","hash":{},"data":data}) : helper)))
    + "\">\n     <h4>How hoppy was it?</h4>\n     <div class=\"dropdown\">\n       <select id=\"ratingdropdown\" name='review[rating]'>\n                      <option value=\"Super Hoppy\">Super Hoppy</option>\n                      <option value=\"Mild Hops\">Mild Hops</option>\n                      <option value=\"Where are the hops?\">Where are the hops?</option>\n                    </select>\n                  </div>\n      <br>\n\n     <input type='submit' class=\"sucessCreate\" id=\"createReview\" name=\"submit\" value=\"Create Review\">\n    </fieldset\n      </form>\n</div>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<!-- <div class=\"chosen-review\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.id : stack1), depth0))
    + "\"> -->\n    <!-- <div class=\"beer\" data-id=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.beer : stack1)) != null ? stack1.id : stack1), depth0))
    + "\"> -->\n    <h4>Beer:"
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.beer : stack1)) != null ? stack1.name : stack1), depth0))
    + "</h4>\n    <h4>Type:"
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.beer : stack1)) != null ? stack1.beer_type : stack1), depth0))
    + "</h4>\n     <h4>Description:"
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.beer : stack1)) != null ? stack1.description : stack1), depth0))
    + "</h4>\n     <div id=\"review-form\" data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n       <form id=\"updateReview\">\n         <fieldset>\n           <input type='hidden' name='review[review_id]' value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n            <input type='hidden' name='review[beer_id]' value=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.beer : stack1)) != null ? stack1.id : stack1), depth0))
    + "\">\n             <h4>Comment</h4>\n          <input type='text' class='reviewcomment' name='review[comment]' value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.comment : stack1), depth0))
    + "\">\n          <h4>How hoppy was it?</h4>\n          <div class=\"dropdown\">\n            <select id=\"ratingdropdown\" name='review[rating]'value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.rating : stack1), depth0))
    + "\">\n              <option value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.rating : stack1), depth0))
    + "\" selected > "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.rating : stack1), depth0))
    + "</option>\n                           <option value=\"Super Hoppy\">Super Hoppy</option>\n                           <option value=\"Mild Hops\">Mild Hops</option>\n                           <option value=\"Where are the hops?\">Where are the hops?</option>\n                         </select>\n                       </div>\n           <br>\n           <input type='submit' class=\"sucessEdit\" name=\"submit\" value=\"Edit Review\">\n           </fieldset\n            </form>\n           </div>\n           </div>\n         </div>\n       </div>\n";
},"useData":true});
